    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            ...
            <div class="row justify-content-between">
                <div class="col">
                    <a class="navbar-brand" href="index.php">Covid<span>-19</span></a>
                </div>
            </div>
            <div class="collapse navbar-collapse navigasi" id="ftco-nav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a href="maps.php" class="nav-link">Maps</a></li>
